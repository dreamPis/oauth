package club.ndt.oauth.boot.handler;


import club.ndt.oauth.boot.exception.ArgumentsFailureException;
import club.ndt.oauth.boot.exception.AuthFailureException;
import club.ndt.oauth.boot.exception.NotAuthException;
import club.ndt.oauth.boot.exception.NotAuthorityException;
import club.ndt.oauth.boot.response.BaseResponse;
import club.ndt.oauth.boot.response.SimpleResponse;
...
import static club.ndt.oauth.boot.response.HttpResponse.baseResponse;
import static club.ndt.oauth.boot.response.HttpResponse.simpleResponse;
